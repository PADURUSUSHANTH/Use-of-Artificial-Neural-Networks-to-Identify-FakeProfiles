...
def importdata(): 
    balance_data = pd.read_csv('C:/Users/Anshr/Downloads/Use of Artificial Neural Networks to Identify FakeProfiles/Use of Artificial Neural Networks to Identify FakeProfiles/SOURCE CODE/Profile/dataset/dataset.txt')
...
def ViewTrain(request):
    if request.method == 'GET':
       ...
       data = pd.read_csv('C:/Users/Anshr/Downloads/Use of Artificial Neural Networks to Identify FakeProfiles/Use of Artificial Neural Networks to Identify FakeProfiles/SOURCE CODE/Profile/dataset/dataset.txt')
...
def UserCheck(request):
    if request.method == 'POST':
      ...
      input+=data+"\n"
      f = open("C:/Users/Anshr/Downloads/Use of Artificial Neural Networks to Identify FakeProfiles/Use of Artificial Neural Networks to Identify FakeProfiles/SOURCE CODE/Profile/dataset/test.txt", "w")
      f.write(input)
      f.close()
      test = pd.read_csv('C:/Users/Anshr/Downloads/Use of Artificial Neural Networks to Identify FakeProfiles/Use of Artificial Neural Networks to Identify FakeProfiles/SOURCE CODE/Profile/dataset/test.txt')
